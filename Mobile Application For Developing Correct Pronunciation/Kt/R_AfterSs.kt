...
class R_AfterSs : AppCompatActivity() {

    private val syllables = listOf("Śre-","Śro-","Śru-")

    private val wordSets = listOf(
        listOf("Średniowiecze", "Średniowieczny","Średnia", "Średni", "Średnio"),
        listOf("Środek", "Środkowy", "Środkowa", "Środkowe", "Środa", "Środowisko"),
        listOf("Śruba", "Śrubokręt", "Śrubować")
    )
