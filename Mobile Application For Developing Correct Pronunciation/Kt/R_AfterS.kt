...
class R_AfterS : AppCompatActivity() {

    private val syllables = listOf("Sre-","Sro-")

    private val wordSets = listOf(
        listOf("Srebrny", "Srebrzysty", "Srebrzyć, Srebrzony"),
        listOf("Srogi", "Srogość", "Srogie", "Sroka", "Srogowatość"),
    )
