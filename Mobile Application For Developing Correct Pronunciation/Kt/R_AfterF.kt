...
class R_AfterF : AppCompatActivity() {

    private val syllables = listOf("fra", "fry","fre","fru","fro")

    private val wordSets = listOf(
        listOf("Frazeologizm", "Frakcja", "Frapujący", "Fragment", "Francuz", "Frapować", "Frasunek", "Frasobliwy", "Franciszkanin", "Fraternizacja"),
        listOf("Fryzjer", "Fryzura", "Frywolny", "Frykasy", "Frykadelki"),
        listOf("Frekwencja", "Frenetyczny", "Frenologia", "Frenzela", "Frenzycznym"),
        listOf("Frutarianizm", "Frutarianin", "Frutarianka", "Frutarianizmu", "Frutarianizmem"),
        listOf("Froterka", "Froterować", "Froterka", "Froterować", "Froterka")
    )

    //utwórz okno, gdzie za pomocą przycisku następny pojawią się kolejne słowa z zestawu
